...
# by adding headlines from the headlines list, inserting a space in 
# between each headline. If necessary, truncate the last headline in 
# the middle so that news_ticker is exactly 140 characters long.
