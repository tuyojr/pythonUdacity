...
# because it creates a ZeroDivisionError exception. Edit the party_planner 
# function to handle this invalid input. If it runs into this exception, it 
# should print a warning message to the user and request they input a different 
# number of people.

# After you've edited the function, try running the file again and make sure it 
# does what you intended. Try it with several different input values, including 
# 0 and other values for the number of people.
...
def party_planner(cookies, people):
    ...
    try:
        ...
        print('You cannot divide the cookies among no attendees')
