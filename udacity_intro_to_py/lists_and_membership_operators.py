# Quiz: List Indexing
# Use list indexing to determine how many days are in a 
# particular month based on the integer variable month, 
...
# Quiz: Slicing Lists
# Select the three most recent dates from this list using list 
# slicing notation. Hint: negative indexes work in slices!
...
# Match the Python code below with the value of the modified sentence1 or 
# sentence2. If the code results in an error, match it with “Error”.
